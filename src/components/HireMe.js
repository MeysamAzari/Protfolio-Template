...
const HireMe = () => {
  return (
    <div className='fixed left-4 bottom-4 flex items-center justify-center overflow-hidden lg:right-8 lg:left-auto lg:top-0 lg:bottom-auto
    lg:absolute sm:right-0'>
                ...
                left-1/2
                 top-1/2
                  -translate-x-1/2
                   ...
                   lg:w-12 lg:h-12 lg:text-[10px]'>Hire Me</Link>
      </div>
    </div>
  )
}
