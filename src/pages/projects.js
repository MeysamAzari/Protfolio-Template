...
const FeaturedProject = ({ type, title, summary, img, link, github }) => {
  return (
    ...
    p-12 relative rounded-br-2xl dark:bg-dark dark:border-light lg:flex-col lg:p-8 xs:rounded-2xl xs:rounded-br-3xl xs:p-4'>
      ...
      <div className='w-1/2 flex flex-col items-start justify-between pl-6 lg:w-full lg:pl-0 lg:pt-6'>
        ...
        <div className='mt-2 flex items-center'>
          ...
          <Link href={link} target='_blank' className='ml-4 rounded-lg bg-dark text-light p-2 px-6
           text-lg font-semibold dark:bg-light dark:text-dark sm:px-4 sm:text-base'>Visit Project</Link>
        </div>
...
const projects = () => {
  return (
    <>
      <Head>
        <title>Meysam Azari | Projects Page</title>
