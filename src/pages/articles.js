...
const MovinImage = ({ title, img, link }) => {
    ...
    return (
        <Link href={link} target='_blank' onMouseMove={handelMouse} onMouseLeave={handelMouseLeave}>
...
const Article = ({ img, title, date, link }) => {
    return (
        ...
        sm:flex-col'>
            <MovinImage title={title} img={img} link={link} />
...
const FeaturedArticle = ({ img, title, time, summary, link }) => {
    return (
        <li className='relative col-span-1 w-full p-4 bg-light border border-solid border-dark rounded-xl dark:border-light dark:bg-dark'>
            ...
            <Link href={link} tabIndex="_blank">
...
const articles = () => {
    return (
        <>
            <Head>
                <title>Meysam Azari | Articles Page</title>
